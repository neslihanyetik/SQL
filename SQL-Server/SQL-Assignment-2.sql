...
--->> CASE: Herhangi bir sorgu sonucunda uygulanan alandan dönen değere göre farklı işlem yapılmasını
--->>       veya farklı metin yazılmasını sağlar. Programlama dillerindeki IF komutuna benzer.

--->> CAST: Bu fonksiyon veri tipi dönüşümünde kullanılır. 
--->>       Örn : integer veritipli bir veriyi float ve ya double a cast edebiliriz.
